...
class Main_Login:
    def __init__(self, root):
        ...
        self.root.geometry('500x500+470+100')
    ...
    def setup_ui(self):
        ...
        # About button
        pic0 = Image.open("photo\\info.png")#================info pic=====================
        ...
        pic = Image.open("photo//school.png")# ==============school image=============
    ...
    def inapp(self):
        D = self.get_pass()
        if self.inter.get() == self.get_name() and str(self.passinter.get()) == D:
            self.back()
            student432.Student432(Tk(),self.inter.get(), self.passinter.get())
