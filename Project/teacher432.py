...
class TEacher:
    def __init__(self,name) :
        ...
        self.stu.iconbitmap('photo//downloading_download_icon_176859.ico')        
        self.Name=name
    ...
    def calculate_final_grade(self):
        ...
        try:
         if self.attendvar.get()!="None" and self.midtermvar.get()!="None" and self.finalvar.get()!="None" and float(self.attendvar.get())<=10  and float(self.midtermvar.get())<=30 and float(self.finalvar.get())<=60:

           self.final_grade = float(self.attendvar.get()) + float(self.midtermvar.get()) + float(self.finalvar.get())
           ...
           return self.evaluressvar    
             ...
             messagebox.showerror("Error","الرجاء تحديد الطالب المراد حساب تقديره")             
    
    def calculate_total_grade(self):
     
        if self.attendvar.get()!="None" and self.midtermvar.get()!="None" and self.finalvar.get()!="None" and float(self.attendvar.get())<=10  and float(self.midtermvar.get())<=30 and float(self.finalvar.get())<=60:

           self.total_grade = float(self.attendvar.get()) + float(self.midtermvar.get()) + float(self.finalvar.get())
