...
class DELETE:
    def __init__(self):
        ...
        self.login.iconbitmap("photo//trash-can_115312.ico")
...
#-----------------------------login app---------------------- 
    def inapp(self):
        ...
        if len(out) == 0:
                messagebox.askretrycancel('Error','الرجاء التأكد من البيانات المدخلة !')  
    ...
    # Fetch values for subjects and build the dictionary
        ...
        if out in all.keys():
             ...
             self.back()
                ...
                messagebox.askretrycancel('Error','المادة المدخلة غير موجودة ضمن مواد الطالب \n  الرجاء اعادة المحاولة')  
